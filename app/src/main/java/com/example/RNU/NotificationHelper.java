...
import static com.example.RNU.Constants.A_MORNING_EVENT_TIME;
import static com.example.RNU.Constants.B_MORNING_EVENT_TIME;
import static com.example.RNU.Constants.A_NIGHT_EVENT_TIME;
import static com.example.RNU.Constants.B_NIGHT_EVENT_TIME;
import static com.example.RNU.Constants.WORK_A_NAME;
import static com.example.RNU.Constants.WORK_B_NAME;
import static com.example.RNU.Constants.KOREA_TIMEZONE;
import static com.example.RNU.Constants.NOTIFICATION_CHANNEL_ID;
...
public class NotificationHelper {
    ...
    public void createNotification(String workName) {
        ...
        notificationBuilder.setSmallIcon(R.drawable.ic_launcher_background) // 기본 제공되는 이미지
        ...
        if (workName.equals(WORK_A_NAME)) {
            ...
            notificationBuilder.setContentTitle("RNU").setContentText("피부측정 하고 건강한피부 만드세요")
